...
\begin{quote}
	texttt{emitDevtoolsEvent(\{ type: 'slotWrite', slotKind: slot.kind, slotKey: key \})}
\end{quote}
...
\subsection{From scratch: what problem are we solving?}
