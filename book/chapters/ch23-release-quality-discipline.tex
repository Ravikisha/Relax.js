...
\begin{itemize}
\item \texttt{**/__tests__/**/*.test.ts}
\item \texttt{**/__tests__/**/*.test.tsx}
\end{itemize}
...
In \texttt{src/__tests__/jsx-tsx.test.ts}, the test sets up a host element in jsdom, runs an example, and asserts on the resulting HTML:
