...
\begin{quote}
  \noindent\textbf{Invariant:} after creation, every child in \texttt{VNode.children} is a VNode (not a primitive) and every node has a stable \texttt{type} drawn from \texttt{DOM\_TYPES}.
\end{quote}
