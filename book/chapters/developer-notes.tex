...
If you want to build your own runtime, you can treat each chapter as a milestone.
At each milestone, try to reproduce the behavior from first principles, then compare your design to Relax\@.js.
