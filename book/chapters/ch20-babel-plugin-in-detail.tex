...
Now we\'ll build the mental model from scratch: how a Babel plugin works, which AST nodes it sees, and how this particular scaffold chooses to represent output.

\section{Babel plugins from scratch: the minimum you need to know}
...
\subsection{From scratch: what the fallback compiler is building}
