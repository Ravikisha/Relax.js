...
\begin{enumerate}
  \item Implement the baseline renderer and component model from \textit{Build a Frontend Web Framework (From Scratch)}.
...
\paragraph{Tests as specs, not as afterthoughts}
