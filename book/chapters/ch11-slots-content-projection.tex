...
\begin{itemize}
  ...
  \item Specs: \texttt{src/__tests__/slots.test.ts} and \texttt{src/__tests__/component-slots.test.ts}
\end{itemize}
...
(See \texttt{src/__tests__/component-slots.test.ts}).
...
This is exactly what \texttt{src/__tests__/slots.test.ts} asserts:
...
This behavior is tested in \texttt{src/__tests__/slots.test.ts}:
...
\subsection{Unit semantics (\texttt{src/__tests__/slots.test.ts})}
...
\subsection{Integration semantics (\texttt{src/__tests__/component-slots.test.ts})}
