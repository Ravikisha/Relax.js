...
This chapter is deliberately practical: we\'ll treat tests as specs, and we\'ll keep the compiler contract small enough that you can maintain it.
...
\section{Babel compilation from scratch: how one JSX element becomes a block}
...
\section{Tests as specs: how to validate compiler changes safely}
...
Now we\'ll do the most valuable ``learn it from scratch'' exercise: take the golden snapshot in
