...
\item it emits a unique sentinel string \texttt{__hrbr_sN__} into the template
...
\item Generate wrapper helpers (e.g. \texttt{__hrbrBlock}) that connect emitted data literals to runtime calls.
