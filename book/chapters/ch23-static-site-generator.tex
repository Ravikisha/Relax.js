...
\begin{itemize}
  \item Chapter~\ref{ch:vnode-model} (VNode model)
  \item Chapter~\ref{ch:mounting} (Mounting)
  \item Chapter~\ref{ch:patching-diffing} (Patching / diffing) --- not because the SSG diffs DOM, but because it explains identity and escaping.
  \item Chapter~\ref{ch:release-quality} (Release-quality discipline) helps for the verification-contract mindset.
\end{itemize}
...
\section{Minimal pipeline: the smallest version that works}
...
\section{Correctness contract (SSG)}
