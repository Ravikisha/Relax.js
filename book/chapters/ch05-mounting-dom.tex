...
We'll dive deeper into listener stability in Chapter~7.
...
\subsection*{From scratch: why I like this explicit \texttt{hostComponent} thread}
...
\subsection*{From scratch: why schedule \texttt{onMounted} instead of calling it directly?}
...
This theme will show up again in scheduling (Chapter~10).
